...
from .user_view import UserView, RegisterView, UserCourseView, ChangePasswordView, FindUserView, FindUserCourseView, CourseInUserCourseExists, AllUsersView, UnregisterUserFromCourseView
