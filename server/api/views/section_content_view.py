...
class SectionContentView(ListCreateAPIView):
    ...
    def get_queryset(self):
        section_id = self.kwargs.get("sectionId")
...
class SingleSectionContentView(APIView):
    ...
    def is_user_registered_to_course(self, request, courseId):
    ...
    def get(self, request, courseId, contentId, *args, **kwargs):
        try:
            if is_user_creator(request, courseId) or self.is_user_registered_to_course(request, courseId):
                section_content = SectionContent.objects.get(id=contentId)
    ...
    def patch(self, request, courseId, contentId, *args, **kwargs):
        try:
            is_user_creator(request, courseId)
            section_content = SectionContent.objects.get(id=contentId)
            serialized_section_content = SectionContentSerializer(
    ...
    def delete(self, request, courseId, contentId, *args, **kwargs):
        try:
            is_user_creator(request, courseId)
            section_content = SectionContent.objects.get(id=contentId)
